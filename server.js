...
function buildPrompt(courseName, pdfDocs) {
  ...
  return [
    ...
    "- Skriv pa svenska med ren och konsekvent formatering.",
    "- Undvik langa kompakta textblock. Dela upp texten med tydliga rubriker, numrering och luft.",
    "- Anvand markdown med exakt den har strukturen i examMarkdown:",
    "  # [Tentatitel]",
    "  ## Instruktioner",
    "  - 3 till 5 korta punkter om tillatna hjalpmedel, poang eller upplagg.",
    "  ## Uppgift 1",
    "  **Poang:** X",
    "  Formulera uppgiften tydligt.",
    "  a) Deluppgift",
    "  b) Deluppgift",
    "  ## Uppgift 2",
    "  ...",
    "- Anvand markdown med exakt den har strukturen i answerKeyMarkdown:",
    "  # Facit",
    "  ## Uppgift 1",
    "  **Kort svar:** ...",
    "  **Losning:**",
    ...
    "  ## Uppgift 2",
    "  ...",
    "- Varje uppgift ska ha egen rubrik pa formen '## Uppgift X'.",
    "- Om en uppgift har delmoment ska de skrivas som 'a)', 'b)', 'c)'.",
    "- Facit ska ha samma uppgiftsnummer som tentan.",
    "- Anvand aldrig tabeller och aldrig LaTeX-block.",
